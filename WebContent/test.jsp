...
try
	{	
		...
		ResultSet rs=ps1.executeQuery();
			...
			%>
	<div class="jumbotron">
		<a href="try.html"><p style="font-color:black; text-align:center;"><img src="pics/cooltext236040979457189.png"/></a>
...
<a href="group.jsp"><div class="container-fluid">
	<div class="row">
    	<div class="col-sm-4 col-md-6">
      		<div class="flip-container" ontouchstart="this.classList.toggle('hover');" >
	<div class="flipper">
		<div class="front">
			<button class="button" style="font-size:27px">Make a group</button>
		</div>
		<div class="back">
			<button class="button">Make Messaging a group affair.Chat with a group here.</button>
		</div>
	</div>
</div>
    	</div>
